...
TEST(PerspectiveFrustumRhTests, PerspectiveProjectionMapsLeftToMinusOneInNDC) {
    float left = -4.0f;
    float right = 4.0f;
    float bottom = -2.0f;
    float top = 3.0f;
...
TEST(PerspectiveFrustumRhTests, PerspectiveProjectionMapsBottomToMinusOneInNDC) {
    float left = -4.0f;
    float right = 4.0f;
    float bottom = -2.0f;
    float top = 3.0f;
...
TEST(PerspectiveFrustumRhTests, PerspectiveProjectionMapsTopToPositiveOneInNDC) {
    ...
    float far = 100.0f;
    auto matrix = glm_metal::perspective_frustum_rh(left, right, bottom, top, near, far);
    auto vector = glm::vec4 { 0.0f, top, 0.0f, 1.0f };
    auto projectedVector = matrix * vector;
    float expected = 1.0f;
    float result = projectedVector.y;
...
TEST(PerspectiveFrustumRhTests, PerspectiveProjectionMapsMinusNearToZeroInNDC) {
    float left = -4.0f;
    float right = 4.0f;
    float bottom = -2.0f;
    float top = 3.0f;
...
TEST(PerspectiveFrustumRhTests, PerspectiveProjectionMapsMinusFarToPositiveOneInNDC) {
    float left = -4.0f;
    float right = 4.0f;
    float bottom = -2.0f;
    float top = 3.0f;
